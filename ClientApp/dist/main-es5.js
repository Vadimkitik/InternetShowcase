...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result != null) {
              ...
              _this2.emailService.SendYourselfEmail(_this2.feedbackForm).subscribe(function (res) {
                ...
                return _this2.toastrService.error(error.error.title);
              });
            }
          });
        }
  ...
  function srcAppSharedModelsFeedbackFormModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FeedbackForm = function FeedbackForm(name, telephone, email, imageUrl, productName, productPrice, message, checkAvailability, checkPrice) {
  ...
  function srcAppSharedServicesGuardsAuthGuardServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AuthGuard, [{
        ...
        key: "isAdminActivate",
        value: function isAdminActivate() {
          var token = this.authService.getToken();
          var user = this.authService.getUser();
  ...
  function srcAppSharedServicesInterseptersErrorIntersepterServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ErrorIntersepterService(toastrService) {
      ...
      _createClass(ErrorIntersepterService, [{
        ...
        value: function intercept(request, next) {
          ...
          return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["retry"])(0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
            var message = "";
            ...
            _this6.toastrService.error("".concat(message, " ").concat(err.status));
    ...
    ErrorIntersepterService.ɵfac = function ErrorIntersepterService_Factory(t) {
      return new (t || ErrorIntersepterService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"]));
    };
  ...
  function srcAppSharedSharedModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_tree_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./services/tree.service */
    "./src/app/shared/services/tree.service.ts");
    /* harmony import */


    var _services_roles_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./services/roles.service */
    "./src/app/shared/services/roles.service.ts");
    /* harmony import */


    var _services_intersepters_token_intersepter_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./services/intersepters/token-intersepter.service */
    "./src/app/shared/services/intersepters/token-intersepter.service.ts");
    /* harmony import */


    var _services_intersepters_error_intersepter_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./services/intersepters/error-intersepter.service */
    "./src/app/shared/services/intersepters/error-intersepter.service.ts");
    /* harmony import */


    var _services_userValidate_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./services/userValidate.service */
    "./src/app/shared/services/userValidate.service.ts");
    /* harmony import */


    var _services_email_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
