        ...
        _createClass(RegistrationComponent, [{
          ...
          value: function onSubmit() {
            ...
            this.authService.register(this.user).subscribe(function (data) {
              _this.toastrService.success("Register successful, check your email");

              console.log("Registered ".concat(_this.user.userName, ", Ok!"));
        ...
        _createClass(ConfirmEmailComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.activatedRoute.queryParams.subscribe(function (queryParam) {
              if (queryParam['code'] == null || queryParam['userId'] == null) {
                _this2.toastrService.warning("Чтобы подтвердить email перейдите по ссылке в письме");
          ...
          value: function confirm(model) {
            ...
            this.authService.confirmEmail(model).subscribe(function (res) {
              _this3.message = "Почта подтверждена успешно. Теперь Вы можете войти в систему.";
              _this3.buttonColor = "primary";
              _this3.load = true;
            }, function (error) {
              console.log(error);
              _this3.message = "При подтверждении пароля вознилка ошибка.";
              _this3.buttonColor = "warn";
              _this3.load = true;
            });
          }
        }]);
        ...
        _createClass(ForgotPasswordComponent, [{
          ...
          value: function onSubmit() {
            ...
            this.authService.forgotPassword(this.forgotUserPassword).subscribe(function (data) {
              _this4.authService.saveForgotPasswordToken(data["token"]);

              _this4.toastrService.success("\u0414\u043B\u044F \u0441\u0431\u0440\u043E\u0441\u0430 \u043F\u0430\u0440\u043E\u043B\u044F \u043F\u0435\u0440\u0435\u0439\u0434\u0438\u0442\u0435 \u043F\u043E \u0441\u0441\u044B\u043B\u043A\u0435 \u0432 \u043F\u0438\u0441\u044C\u043C\u0435,\n         \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043D\u043E\u043C \u043D\u0430 \u0432\u0430\u0448 Email ".concat(_this4.email.value));
        ...
        _createClass(LoginComponent, [{
          ...
          value: function onSubmit() {
            ...
            this.authService.login(this.form.value).subscribe(function (data) {
              _this5.toastrService.success("Loggin successful");

              _this5.authService.saveToken(data["token"]);

              _this5.authService.saveUser(data["userName"], data["email"], data['userRoles']);

              _this5.router.navigate(['/admin-panel/products']);
            });
          }
        }, {
          key: "getErrorMessageEmail",
