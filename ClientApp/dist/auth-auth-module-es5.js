...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-auth-module"], {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.authService.login1(this.form.value).subscribe(function (response) {
            ...
            _this2.tokenStorage.saveToken(token);

            _this2.tokenStorage.saveUser(response);

            _this2.authService.login();

            _this2.name = _this2.tokenStorage.getUser().name;
            _this2.message.text = '';
            console.log("Loggin successful, ".concat(name));

            _this2.router.navigate(['/admin-panel']);
          }, function (error) {
            _this2.showMessage({
        ...
        key: "getErrorMessagePassv",
        value: function getErrorMessagePassv() {
  ...
  function srcAppAuthRegistrationRegistrationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function RegistrationComponent(router, usersService, formBuilder) {
      ...
      _createClass(RegistrationComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.usersService.createUser(this.user).subscribe(function (user) {
        ...
        key: "getErrorMessagePassvConf",
        value: function getErrorMessagePassvConf() {
    ...
    RegistrationComponent.ɵfac = function RegistrationComponent_Factory(t) {
      return new (t || RegistrationComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_shared_services_users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]));
    };
